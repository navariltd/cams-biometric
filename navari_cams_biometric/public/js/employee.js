...
frappe.ui.form.on("Employee", {
  refresh: function (frm) {
    if (frm.doc.custom_biometric_registered === 0) {
      (frm
        .add_custom_button(__("Register Biometric ID"), function () {
          let d = new frappe.ui.Dialog({
            ...
            primary_action: function (data) {
              ...
              frappe.call({
                method:
                  "navari_frappehr_biostar.controllers.cams_call.add_user",
                args: {
    ...
    if (frm.doc.custom_biometric_registered === 1) {
      frm
        .add_custom_button(__("Delete Biometric ID"), function () {
          let d = new frappe.ui.Dialog({
            ...
            primary_action: function (data) {
              ...
              frappe.call({
                method:
                  "navari_frappehr_biostar.controllers.cams_call.delete_user",
                args: {
                  user_id: data.user_id,
                },
                callback: function (r) {
    ...
    frm
      .add_custom_button(__("Add Photo"), function () {
        let d = new frappe.ui.Dialog({
          title: "Add Photo",
          fields: [
            {
